    ...
    public class ProductoService : IProductoService
    {
        ...
        public async Task<bool> Editar(ProductoDTO modelo)
        {
            try
            {
                ...
                var productoModelo = _mapper.Map<Producto>(modelo); // Crear el producto mapeando el DTO a la entidad Producto
                var productoEncontrado= await _productoRepositorio.Obtener(u => u.IdProducto == productoModelo.IdProducto); //Devuelve la entidad completa
                ...
                bool respuesta = await _productoRepositorio.Editar(productoEncontrado); //Retorna true o false
